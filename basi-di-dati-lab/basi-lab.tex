...
conn.commit()
		\end{lstlisting}
		dove \lstinline|statement| è lo statement da eseguire sulla base di dati, mentre \lstinline|commit()| esegue effettivamente l'operazione.
...
with conn.cursor as cur:
	...
	...
	\end{lstlisting}
	In questo modo \textbf{non serve il commit}, in quanto viene fatto automaticamente al termine dell'esecuzione del corpo del \verb|with|.
