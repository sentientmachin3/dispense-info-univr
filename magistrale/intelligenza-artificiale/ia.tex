...
\begin{itemize}
	...
	\item agenti \textit{goal-based} $ \rightarrow $ le azioni sono condizionate in base al goal prefissato, anche qui è presente uno stato che influisce sul raggiungimento del goal;
