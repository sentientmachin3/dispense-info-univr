...
\begin{document}
	...
	\section{Proprietà dei sistemi}
		\subsection{Sistemi dinamici o istantanei}
			...
			Condizione necessaria e sufficiente affinché un sistema MIMO con ingressi e uscite sia istantaneo è che il legame \textbf{IU} sia espresso da un insieme di equazioni della forma:
			\[
				\begin{cases}
