	...
	\subsection{Lista dei problemi visti e complessità}
		\begin{figure}[h!]
			\begin{tabular}{lcccccc}
				\toprule
				\textbf{Problema} & $ \p $ & $ \np $ & $ \npc $ & $ \conp\mathbf{C} $ & $ \pspace $ & $ \pspace$-completo \\
				\midrule
				Eulerian Cycle & \checkmark & & & & \checkmark & \\
				K-Colouring (K=2) & \checkmark & & & & \checkmark & \\
				K-Colouring (K>2) & & \checkmark & \checkmark & & \checkmark & \\
				K-SAT (K=2) & \checkmark & & & & \checkmark & \\
				K-SAT (K>2) & & \checkmark & \checkmark & & \checkmark & \\
				Circuit-SAT & & \checkmark & \checkmark & & \checkmark &  \\
				Tautology & & & & \checkmark & \checkmark & \\
				Min-Circuit Bool & & & & & \checkmark & \\
				Graph Isomorphism & & \checkmark & & & \checkmark & \\
				Clique & & \checkmark & \checkmark & & \checkmark & \\
				Clique-no-Clique & & \checkmark & \checkmark & & \checkmark & \\
				Independent Set & & \checkmark & \checkmark & & \checkmark & \\
				Only Small IndSet & & \checkmark & \checkmark & & \checkmark & \\
				Vertex Cover & & \checkmark & \checkmark & & \checkmark & \\
				Hitting Set & & \checkmark & \checkmark & & \checkmark & \\
				Max Cut & & \checkmark & \checkmark & & \checkmark & \\
				Set Splitting & & \checkmark & \checkmark & & \checkmark & \\
				Set Cover & & \checkmark & \checkmark & & \checkmark & \\
		...
		\begin{figure}[t]		
			\begin{tabular}{lcccccc}
				...
				Geography & & & & & & \checkmark \\
				Alternating Hampath & & & & & & \checkmark \\
				Reachability* & \checkmark & & & & \checkmark & \\
				Makespan-m & & \checkmark & \checkmark & & \checkmark & \\
				SubsetSum & & \checkmark & \checkmark & & \checkmark & \\
				Partition & & \checkmark & \checkmark & & \checkmark & \\
				Traveling Salesman & & \checkmark & \checkmark & & \checkmark & \\
				Knapsack & & \checkmark & \checkmark & & \checkmark & \\
				Max-k-xor-SAT & & \checkmark & \checkmark & & \checkmark & \\
				Max-k-SAT & & \checkmark & \checkmark & & \checkmark & \\
				Set Cover & & \checkmark & \checkmark & & \checkmark & \\
				\bottomrule
			\end{tabular}
