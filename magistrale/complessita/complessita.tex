	...
	\begin{figure}[h!]
		\centering
			\begin{tikzpicture}[scale=1.1]
				\draw (0,0) ellipse (7cm and 5cm) node[yshift=5cm] {$ \Exp $};
				\draw (0,0) ellipse (6.5cm and 4cm) node[yshift=4cm] {$ \pspace = \npspace $};
				\draw (3,1) ellipse (2cm and 2cm) node {$ \pspace-$completo};
				\draw (-2.5,-.5) ellipse (3.5cm and 2.5cm) node[yshift=2.5cm] {$ \ph $};
				...
				\draw (-2.5,-.5) ellipse (3cm and 2cm) node[yshift=2cm] {$ \np $};
				\draw (-4,-.5) ellipse (1.4cm and 1.4cm) node[yshift=1.3cm] {$ \p $};
