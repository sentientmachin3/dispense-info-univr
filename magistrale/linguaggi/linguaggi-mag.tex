...
Inoltre, in modalità call-by-value: \begin{align*}
	\inference[CBV.A]{M_2 \rightarrowtriangle M_2'}{(\lambda x.M)M_2 \rightarrowtriangle (\lambda x.M)M_2'} \quad \inference[CBV.B]{-}{(\lambda x.M)v \rightarrowtriangle \subs{M}{v}{x}}
\end{align*}
mentre in modalità call-by-name: \[ \inference[CBN]{-}{(\lambda x.M)M_2 \rightarrowtriangle \subs{M}{M_2}{x}} \]
