...
\subsection*{Grammatica delle espressioni}
	\begin{align*}
		op\ :\colon =&\ +\ \mid\ \geq \\ \\
		e\in \textup{Exp}\ :\colon =&\ n\ \mid\ b\ \mid\ e\ \textup{op}\ e\ \mid\ \textup{if}\ e\ \textup{then}\ e\ \textup{else}\ e\ \mid\ l\colon = e\ \mid\ !l\ \mid\ \textup{skip}\ \mid\ e;e\ \mid\ \textup{while}\ e\ \textup{do}\ e\ \mid 
		 \text{fn } x\colon T\ \Rightarrow\ e\ \mid\ e_1 e_2\ \mid\  \text{let } x\colon T = e\ \textup{in } e\ \mid\ e\oplus e\ \mid\ e\| e\ \mid\ \textup{await}\ e\ \textup{protect}\ e\ \textup{end}
	\end{align*}
