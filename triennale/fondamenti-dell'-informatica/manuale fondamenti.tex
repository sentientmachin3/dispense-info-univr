...
\textbf{ATTENZIONE! WARNING! QUESTA PARTE E' INCOMPLETA!!!}\\
...
\begin{center}
    ...
    % Bracket rectangle
    \def\y{0.5*10}
    \draw [decorate, decoration={brace, amplitude=5pt}] ($(a1)+(0,\y)$.north east) -- ($(b1)+(0,\y)$.north west) node [midway, above=0.2cm] {n};
    \draw [decorate, decoration={brace, amplitude=5pt}] ($(b1)+(0,\y)$.north east) -- ($(c1)+(0,\y)$.north west) node [midway, above=0.2cm] {n};
    \draw [decorate, decoration={brace, amplitude=5pt}] ($(c1)+(0,\y)$.north east) -- ($(d1)+(0,\y)$.north west) node [midway, above=0.2cm] {n};
